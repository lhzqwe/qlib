...
from feishu_bot import enqueue_feishu_error, enqueue_feishu_preview
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--runs-root", default=str(SCRIPT_DIR / "output"), help="Search root when --strategy-run-dir is omitted.")
